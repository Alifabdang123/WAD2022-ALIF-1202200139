...
include 'config/connector.php';
  ...
  if (isset($_GET['id_mobil'])) {
    ...
    $query = "SELECT * FROM showroom_Alif_table WHERE id_mobil='$id_mobil'";
    ...
    $data = mysqli_fetch_assoc($result);
      // apabila data tidak ada pada database maka akan dijalankan perintah ini
       if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='ListCar-Alif.php';</script>";
       }
  } else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Masukkan data id');window.location='ListCar-Alif.php';</script>";
  }         
  ?>
<!doctype html>
<html lang="en">
