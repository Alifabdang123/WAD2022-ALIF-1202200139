    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="Home-Alif.php">Home</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="ListCar-Alif.php">My Car</a>
                </li>
            </ul>
            <form class="d-flex justify-content-end" action="#">
                <li>
                <a href="Add-Alif.php" class="btn btn-light">Add car</a>
</li>
<div class="dropdown">
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="Profile-Alif.php">Profile</a></li>
    ...
    <div class="container p-5">
        ...
        <!-- read -->
            <div class="row g-2">
            <?php
                $sql = "SELECT * FROM showroom_Alif_table ORDER BY id_mobil ASC";
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-start">
                                <div class="row">
                                    <div class="col">
                                        <a href="Detail-Alif.php?id_mobil=<?php echo $mycar['id_mobil'];?>" class="btn btn-primary rounded-4">Detail</a>
                                    </div>
                                    <div class="col">
