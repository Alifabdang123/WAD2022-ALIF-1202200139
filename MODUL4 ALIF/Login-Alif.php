...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="index.php">SHOWROOM ALIF</a>
                </li>
            </ul>
    </nav>
    ...
    <div class="container">
        ...
        if(!empty($_SESSION['success'])) { ?>
            ...
            <div class="row g-2">
            <div class="col-6">
            <img src="BMW.jpg" class="img-fluid rounded-start" alt="...">
        </div>
            <div class="col-6">
                <form method="post" action="config/check_login.php">
                    ...
                    <label class="form-check-label" for="exampleCheck1">Belum punya akun? <a
                            href="Register-Alif.php">Register</a></label>
                </form>
            </div>
